...
//ethereum
    if (ad.chain == 'ETH') {
      eth_courl = "https://api.switcheo.network/v2/balances?addresses=" + ad.address + "&contract_hashes=0x7ee7Ca6e75de79e618e88bdf80d0b1db136b22d0";
...
async function ontupdate() {
  ...
  }).catch(function() { vm.w = '';//'!onttxns\u26A0'; 
  vm.status += 5;// заглушка
  ontupd = 1});
  }
...
try { 
      ...
      for (var itx of eth_a) {  
        ...
        if (txad == '0x7ee7Ca6e75de79e618e88bdf80d0b1db136b22d0') {txad = 'Switcheo Exchange'}
